...
public class MainActivity extends Activity implements SensorEventListener {
    ...
    public static final byte BT_BATT_SOC = 1;

    public static final byte BT_BATT_TIME_LEFT = 2;

    public static final byte BT_BATT_HI_AVG_TEMP = 4;

    public static final byte BT_CAR_STARTUP_STATE = 6;

    public static final byte BT_MOTOR_TEMP = 8;

    public static final byte BT_CAR_SPEED = 10;
        ...
        public boolean handleMessage(Message message) {
            ...
            switch (data[0]) {
                ...
                case BT_BATT_HI_AVG_TEMP:
                    ...
                    int high = data[BT_BATT_HI_AVG_TEMP] & 0xFF;

                    int avg = data[BT_BATT_HI_AVG_TEMP + 1] & 0xFF;
                ...
                case BT_CAR_STARTUP_STATE:
                    ...
                    BluetoothCommService.log(currentState + ", " + data[1]);

                    handleStartupCode(data[BT_CAR_STARTUP_STATE]);
                    break;

                case BT_CAR_SPEED:

                    int speed = ((data[BT_CAR_SPEED + 1] & 0xFF) << 8)

                            | (data[BT_CAR_SPEED] & 0xFF);
